...
config = {
    ...
    "060.UD作成": {
        ...
        "artifact_matcher": ["060_レビューチェックリスト_", "レビュー記録表_UD作成"],
    },
    "070.UD消化": {
        "top_level_matcher": ["単体試験成績書_"],
        "artifact_matcher": ["070_レビューチェックリスト_", "レビュー記録表_UD消化"],
    },
    "080.SD作成": {
        "top_level_matcher": ["結合試験仕様書_"],
        "artifact_matcher": ["080_レビューチェックリスト_", "レビュー記録表_SD作成"],
    },
    "090.SD消化": {
        "top_level_matcher": ["結合試験成績書_", "試験結果報告書_"],
        "artifact_matcher": ["090_レビューチェックリスト_", "レビュー記録表_SD消化"],
    },
}
